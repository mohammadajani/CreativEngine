  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `url('https://images.pexels.com/photos/3184433/pexels-photo-3184433.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')`, // Updated to a new vibrant Pexels image
        }}
      >
